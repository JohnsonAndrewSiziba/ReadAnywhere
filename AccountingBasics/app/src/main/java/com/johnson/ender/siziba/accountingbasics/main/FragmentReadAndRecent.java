package com.johnson.ender.siziba.accountingbasics.main;
...
import com.johnson.ender.siziba.accountingbasics.R;
import com.johnson.ender.siziba.accountingbasics.Read;
import com.johnson.ender.siziba.accountingbasics.adapters.NewsAdapter;
import com.johnson.ender.siziba.accountingbasics.adapters.NewsItem;
import com.johnson.ender.siziba.accountingbasics.database.DBManager;
import com.johnson.ender.siziba.accountingbasics.helpers.TimeUtility;
...
//                startActivity(new Intent(getActivity(), Read.class));
                ...
                intent.putExtra("THE_LINK", "file:///android_asset/accounting_basics/index.htm");
