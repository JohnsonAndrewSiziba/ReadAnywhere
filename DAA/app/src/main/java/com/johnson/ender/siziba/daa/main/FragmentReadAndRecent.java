package com.johnson.ender.siziba.daa.main;
...
import com.johnson.ender.siziba.daa.R;
import com.johnson.ender.siziba.daa.Read;
import com.johnson.ender.siziba.daa.adapters.NewsAdapter;
import com.johnson.ender.siziba.daa.adapters.NewsItem;
import com.johnson.ender.siziba.daa.database.DBManager;
import com.johnson.ender.siziba.daa.helpers.TimeUtility;
...
//                startActivity(new Intent(getActivity(), Read.class));
                ...
                intent.putExtra("THE_LINK", "file:///android_asset/design_and_analysis_of_algorithms/index.htm");
