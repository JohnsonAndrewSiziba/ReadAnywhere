package com.johnson.ender.siziba.financialaccounting.main;
...
import com.johnson.ender.siziba.financialaccounting.R;
import com.johnson.ender.siziba.financialaccounting.Read;
import com.johnson.ender.siziba.financialaccounting.adapters.NewsAdapter;
import com.johnson.ender.siziba.financialaccounting.adapters.NewsItem;
import com.johnson.ender.siziba.financialaccounting.database.DBManager;
import com.johnson.ender.siziba.financialaccounting.helpers.TimeUtility;
...
//                startActivity(new Intent(getActivity(), Read.class));
                ...
                intent.putExtra("THE_LINK", "file:///android_asset/financial_accounting/index.htm");
