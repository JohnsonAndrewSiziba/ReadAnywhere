package com.johnson.ender.siziba.discretemath.main;
...
import com.johnson.ender.siziba.discretemath.R;
import com.johnson.ender.siziba.discretemath.Read;
import com.johnson.ender.siziba.discretemath.adapters.NewsAdapter;
import com.johnson.ender.siziba.discretemath.adapters.NewsItem;
import com.johnson.ender.siziba.discretemath.database.DBManager;
import com.johnson.ender.siziba.discretemath.helpers.TimeUtility;
...
//                startActivity(new Intent(getActivity(), Read.class));
                ...
                intent.putExtra("THE_LINK", "file:///android_asset/discrete_mathematics/index.htm");
