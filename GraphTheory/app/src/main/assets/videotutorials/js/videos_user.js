$(document).ready(function () {
   ...
   $("#divTutorialContent").on("keyup", ".clsConvert", function () {
    ...
    $('#btnIndiaBankDetails').click(function () {
        ...
        var isPanValid = panregex.test(panNumber);
		...
		}else if (panNumber == '')
        {
            ...
            $('.txtClass').next().html('');
            $('#panNumber').next().html("Invalid Pan Numeber format (Ex: ABCDE6789J)");
            $('#panNumber').focus();
            $('#panNumber').css('border-color', 'red');
            return false;
        } 
    ...
    $('#btnSaveCouponCodeDetails').click(function () {
        ...
        } else if (coupon_mode == '')
        {
            ...
            $('.txtClass').next().html('');
            $('#coupon_mode').next().html('Please select Coupon Type');
            $('#coupon_mode').focus();
            $('#coupon_mode').css('border-color', 'red');
            return false;
        ...
        formdata.append('coupon_mode', coupon_mode);
        ...
        $.ajax({
            ...
            if (data.flag == -99) {
                ...
                window.location = videobaseurl + "/admin_coupon_list.php";
            } else if (data.flag == 0) {
                $('.alert-danger span').html(data.msg);
                $('.alert-danger').show();
                setTimeout(function () {
